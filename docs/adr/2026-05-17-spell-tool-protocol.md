...
把“语音咒语工具协议”记录为方案B，一个优质候选方案，但暂不设为默认路线。默认路线优先继续调研官方支持的方案A。
...
方案A优先使用官方 API 提供的能力，例如内置联网搜索、外部 RAG、上下文管理和文本 query。如果官方能力足够覆盖工具需求，优先方案A。方案B保留给官方能力不支持通用外部工具编排的场景。
